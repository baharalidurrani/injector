...
link.href =
  "https://baharalidurrani.gitlab.io/resume/assets/dep/css/bootstrap-tour-standalone.min.css";
head.appendChild(link);
link.onload = function () {
  var jq = document.createElement("script");
  // s.src = chrome.extension.getURL("driver.js");
  jq.src =
    "https://baharalidurrani.gitlab.io/resume/assets/dep/js/jquery-3.5.1.min.js";
  (document.head || document.documentElement).appendChild(jq);
  jq.onload = function () {
    var boot = document.createElement("script");
    // s.src = chrome.extension.getURL("driver.js");
    boot.src =
      "https://baharalidurrani.gitlab.io/resume/assets/dep/js/bootstrap-tour-standalone.min.js";
